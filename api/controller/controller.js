...
exports.get_hot_manga_update_cache = (req, res) => {
    const result = myCache.get('/api/hot_manga_update/')
    if (result != undefined) {
        res.send(result);
    }
    else
...
exports.get_chapter_cache = (req, res) => {
    ...
    const result = myCache.get(chapter_endpoint)
    if (result != undefined) {
        res.send(result);
    }
    else
...
exports.get_all_genre_cache = (req, res) => {
    ...
    const result = myCache.get('/api/genre/all')
    if (result != undefined) {
        res.send(result);
    }
    else
...
exports.get_genre_cache = (req, res) => {
    ...
    const result = myCache.get(genre_endpoint + page_number)
    if (result != undefined) {
        res.send(result);
    }
    else
...
exports.get_latest_update_cache = (req, res) => {
    ...
    const result = myCache.get('/api/latest_update/' + page_number)
    if (result != undefined) {
        res.send(result);
    }
    else
...
exports.get_search_manga_cache = (req, res) => {
    ...
    const result = myCache.get('search: ' + query)
    if (result != undefined) {
        res.send(result);
    }
    else
...
exports.get_all_manga_cache = (req, res) => {
    ...
    const result = myCache.get('manga/' + page_number)
    if (result != undefined) {
        res.send(result);
    }
    else
...
exports.get_all_manhwa_cache = (req, res) => {
    ...
    const result = myCache.get('manhwa/' + page_number)
    if (result != undefined) {
        res.send(result);
    }
    else
...
exports.get_all_manhua_cache = (req, res) => {
    ...
    const result = myCache.get('manhua/' + page_number)
    if (result != undefined) {
        res.send(result);
    }
    else
...
exports.get_best_series_cache = (req, res) => {
    const result = myCache.get('best-series')
    if (result != undefined) {
        res.send(result);
    }
    else
